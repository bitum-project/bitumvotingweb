...
const (
	defaultConfigFilename = "bitumvotingweb.conf"
)
...
var (
	...
	defaultHomeDir     = bitumutil.AppDataDir("bitumvotingweb", false)
...
type config struct {
	...
	RPCHost    string `short:"c" long:"rpchost" description:"Hostname/IP and port of bitumd RPC server to connect to"`
	RPCUser    string `short:"u" long:"rpcuser" description:"Username for RPC connections"`
	RPCPass    string `short:"P" long:"rpcpass" default-mask:"-" description:"Password for RPC connections"`
	RPCCert    string `long:"rpccert" description:"File containing the bitumd certificate file"`
